...
-- ── Drag меню — тянуть за сайдбар ─────────────────────
do
    local dragging,dragStart,startPos=false,nil,nil
    -- Drag вешаем на topbar (горизонтальная полоска с вкладками) — не мешает иконкам
    local topbarFrame=mainArea:FindFirstChildOfClass("Frame") or win
    local dragZone=Instance.new("TextButton",topbarFrame)
